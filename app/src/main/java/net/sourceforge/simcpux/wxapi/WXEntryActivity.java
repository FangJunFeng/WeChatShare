 ...
 * create time：2017/1/12 15:38<br/>
 * ===============================<br/>
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        regBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 将该app注册到微信
                boolean result = api.registerApp(Constants.APP_ID);
                Toast.makeText(getApplicationContext(), result ? "register succeed" : "register fail", Toast.LENGTH_SHORT).show();
            }
        });
